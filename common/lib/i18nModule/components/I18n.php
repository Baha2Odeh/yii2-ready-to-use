...
class I18n extends \yii\i18n\I18N
{
    ...
    public function init()
    {
        ...
        if (!is_array($this->languages)) {
            throw new InvalidConfigException('\common\lib\i18nModule\components\I18n::languages have to be array.');
        }

        if (empty($this->languages)) {
            throw new InvalidConfigException('\common\lib\i18nModule\components\I18n::languages have to contains at least 1 item.');
        }
    ...
    protected function getMessageSourceConfig()
    {
        ...
        if ($this->handleMissing) {
            $defaults['on missingTranslation'] = [
                'common\lib\i18nModule\components\TranslationEventHandler',
